...
constexpr uint8_t SDA_PIN = 21; //SDA pin for I2C communication with the sensor
constexpr uint8_t SCL_PIN = 22; //SCL pin for I2C communication with the sensor
constexpr uint16_t HTTP_TIMEOUT = 1000; //timeout for HTTP requests in milliseconds
...
constexpr uint16_t STRIKE_THRESHOLD = 5;    //threshold for detecting strike
